...
namespace Kisiler.ServiceReference1 {
    ...
    public interface KPSPublicSoap {
        ...
        Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public Kisiler.ServiceReference1.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(Kisiler.ServiceReference1.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public Kisiler.ServiceReference1.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(Kisiler.ServiceReference1.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : Kisiler.ServiceReference1.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<Kisiler.ServiceReference1.KPSPublicSoap>, Kisiler.ServiceReference1.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse Kisiler.ServiceReference1.KPSPublicSoap.TCKimlikNoDogrula(Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest inValue = new Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest();
            inValue.Body = new Kisiler.ServiceReference1.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse retVal = ((Kisiler.ServiceReference1.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse> Kisiler.ServiceReference1.KPSPublicSoap.TCKimlikNoDogrulaAsync(Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<Kisiler.ServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest inValue = new Kisiler.ServiceReference1.TCKimlikNoDogrulaRequest();
            inValue.Body = new Kisiler.ServiceReference1.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((Kisiler.ServiceReference1.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
